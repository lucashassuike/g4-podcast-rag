...
# ── Podcast Index ───────────────────────────────────────────
PI_API_KEY = os.getenv("PODCAST_INDEX_API_KEY", "")
PI_API_SECRET = os.getenv("PODCAST_INDEX_API_SECRET", "")
PI_FEED_ID = os.getenv("PODCAST_INDEX_FEED_ID", "2788697")
...
AZURE_TRANSCRIPTION_MODEL = os.getenv("AZURE_TRANSCRIPTION_DEPLOYMENT", "gpt-4o-transcribe-2")
AZURE_EMBEDDING_MODEL = os.getenv("AZURE_EMBEDDING_DEPLOYMENT", "text-embedding-ada-002")
AZURE_EMBEDDING_API_VERSION = os.getenv("AZURE_EMBEDDING_API_VERSION", "2023-05-15")
AZURE_DIARIZE_MODEL = os.getenv("AZURE_DIARIZE_DEPLOYMENT", "gpt-4o-transcribe-diarize-2")

# ── Azure Speech (diarização) ───────────────────────────────
AZURE_SPEECH_KEY = os.getenv("AZURE_SPEECH_KEY", AZURE_API_KEY)
AZURE_SPEECH_REGION = os.getenv("AZURE_SPEECH_REGION", "eastus2")

# ── Azure Chat (GPT-4o para extração) ──────────────────────
AZURE_CHAT_MODEL = os.getenv("AZURE_CHAT_DEPLOYMENT", "gpt-4o")
AZURE_CHAT_API_VERSION = os.getenv("AZURE_CHAT_API_VERSION", "2025-03-01-preview")
